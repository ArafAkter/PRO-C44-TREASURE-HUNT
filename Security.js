...
this.button1.mousePressed(() => {
    if(system.authenticate(this.access1.value(),"VARIABLE")){
        this.button1.hide()
        this.access1.hide()
        score++
    }
...
this.button2.mousePressed(() => {
    if(system.authenticate(this.access2.value(),"DATABASE")){
        this.button2.hide()
        this.access2.hide()
        score++
    }
...
this.button3.mousePressed(() => {
    if(system.authenticate(this.access3.value(),"FUNCTION")){
        this.button3.hide()
        this.access3.hide()
        score++
    }
